...
var actionName = 'http.commerce.catalog.storefront.products.getProducts.after';

describe('http.commerce.catalog.storefront.products.getProducts.after implementing http.commerce.catalog.storefront.products.getProducts.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.catalog.storefront.products/http.commerce.catalog.storefront.products.getProducts.after');
  });
