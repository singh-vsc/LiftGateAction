...
var actionName = 'http.commerce.catalog.storefront.products.getProducts.before';

describe('http.commerce.catalog.storefront.products.getProducts.before implementing http.commerce.catalog.storefront.products.getProducts.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.catalog.storefront.products/http.commerce.catalog.storefront.products.getProducts.before');
  });
