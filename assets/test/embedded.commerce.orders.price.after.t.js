...
var actionName = 'embedded.commerce.orders.price.after';

describe('embedded.commerce.orders.price.after implementing embedded.commerce.orders.price.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/commerce.orders/embedded.commerce.orders.price.after');
  });
