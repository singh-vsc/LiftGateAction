...
var actionName = 'http.storefront.pages.category.request.after';

describe('http.storefront.pages.category.request.after implementing http.storefront.pages.category.request.after', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/http.storefront.pages.category.request.after');
  });
