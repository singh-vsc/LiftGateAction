...
var actionName = 'http.storefront.pages.category.request.before';

describe('http.storefront.pages.category.request.before implementing http.storefront.pages.category.request.before', function () {

  var action;

  before(function () {
    action = require('../src/domains/storefront/http.storefront.pages.category.request.before');
  });
