...
/**
 * Implementation for http.storefront.pages.category.request.after
...
/**
 * Implementation for http.storefront.pages.category.request.before
...
},{"mozu-node-sdk/clients/commerce/order":9}],6:[function(require,module,exports){
module.exports = {
...
},{"./domains/storefront/http.storefront.pages.cart.request.after":1,"./domains/storefront/http.storefront.pages.cart.request.before":2,"./domains/storefront/http.storefront.pages.category.request.after":3,"./domains/storefront/http.storefront.pages.category.request.before":4,"./domains/storefront/liftgateCustom":5}],7:[function(require,module,exports){
module.exports={
  "Production/Sandbox": {
...
},{"./constants":11,"./plugins/expand-uritemplate-from-context":12,"./plugins/in-memory-auth-cache":13,"./plugins/server-side-prerequisites":19,"./utils/get-config":23,"./utils/make-method":25,"./utils/normalize-context":26,"./utils/sub":30,"./utils/tiny-extend":32}],9:[function(require,module,exports){
...
},{"assert":undefined}],14:[function(require,module,exports){
'use strict';
...
},{"../constants":11,"./errorify":22,"./parse-json-dates":27,"./stream-to-callback":29,"./tiny-extend":32,"http":undefined,"https":undefined,"url":undefined}],29:[function(require,module,exports){
'use strict';
